...
@Service
public class AuthenticatedBulletinRecentListService implements AbstractListService<Authenticated, Bulletin>{
	...
	public Collection<Bulletin> findMany(final Request<Bulletin> request) {
		...
		result = this.repository.findRecentBulletin(deadline);
