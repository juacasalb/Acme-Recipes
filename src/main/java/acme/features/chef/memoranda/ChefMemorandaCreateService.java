...
public class ChefMemorandaCreateService implements AbstractCreateService<Chef, Memorandum> {
	...
	public void bind(final Request<Memorandum> request, final Memorandum entity, final Errors errors) {
		...
		memAmount = this.repository.countMemorandum() + 1;
		...
		System.out.println("===================================");
		System.out.println("Attributes de la entity:");
		
		System.out.println("automaticSeqNum: " + entity.getAutomaticSeqNum());
		System.out.println("fineDish: " + entity.getFineDish().toString());
		System.out.println("instantiationMoment: " + entity.getInstantiationMoment().toString());
		System.out.println("report: " + entity.getReport());
