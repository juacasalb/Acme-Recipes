...
@Service
public class EpicureFineDishListAcceptedService implements AbstractListService<Epicure,FineDish>  {
	...
	public Collection<FineDish> findMany(final Request<FineDish> request) {
		...
		result= this.repository.findDishesByEpicureIdAndState(epicureId,State.ACCEPTED);
		return result;
	}
