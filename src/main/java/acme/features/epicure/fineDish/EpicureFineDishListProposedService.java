...
@Service
public class EpicureFineDishListProposedService implements AbstractListService<Epicure,FineDish>  {
	...
	public Collection<FineDish> findMany(final Request<FineDish> request) {
		...
		result= this.repository.findDishesByEpicureIdAndState(epicureId,State.PROPOSED);
		return result;
	}
